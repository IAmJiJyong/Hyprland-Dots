...
declare -A online_music=(
  ...
  ["YT - 西洋音樂 📻🎶"]="https://youtube.com/playlist?list=PLQ_yPjXSmb0xJKhp_bHiFlBQD37W0oSqo&si=klt8yroDqqzQB8Qv"
  ["YT - 琅琅上口的華語歌 📻🎶"]="https://www.youtube.com/playlist?list=RDCLAK5uy_mijutvVbzp7bbNlWt-B5U90qb5KplCkSQ"
  ["YT - 華語抒情歌單 📻🎶"]="https://youtube.com/playlist?list=PLQ_yPjXSmb0xTUPaGK4r6wf8Ul4rAIAx5"
)
...
play_local_music() {
  ...
  choice=$(printf "%s\n" "${filenames[@]}" | rofi -i -dmenu -config ~/.config/rofi/config-beats.rasi -p "Local Music")
...
play_online_music() {
  choice=$(printf "%s\n" "${!online_music[@]}" | rofi -i -dmenu -config ~/.config/rofi/config-beats.rasi -p "Online Music")
